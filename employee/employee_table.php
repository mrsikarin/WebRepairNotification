              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php if ($repairs['repair_status'] == "pending") {echo "รอดำเนินการ";} 
                              elseif ($repairs['repair_status'] == "in progress") {echo "กำลังดำเนินการ";} 
                              elseif ($repairs['repair_status'] == "successfully") {echo "เสร็จสิ้น";} 
                              else {echo "ยกเลิก";} ?>
                    </td>
                  </tr>
                <?php
