      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <div class="mb-3">
            ...
            <br>
            <div class="mb-3">
                <a href="employee_profile_password.php?id=<?php echo $row['id']; ?>" title="เปลี่ยนรหัสผ่าน" class="button button1"><i class='bx bx-key'></i></a>
                <a href="employee_profile_edit.php?id=<?php echo $row['id'];?>" title="แก้ไข" class="button button4"><i class='bx bx-edit'></i></a>              
            </div>
          </div>
        </div>   
      </div>
