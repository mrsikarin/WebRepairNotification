...
<div class="sales-boxes">
    <div class="recent-sales box">
        ...
        <hr>
        <form action="building_edit.php" method="GET">

            <div class="mb-3">
                <input type="hidden" name="ser_id2" value="<?php echo $_GET['id'];?>">
            </div>
            <div class="mb-3">  
                <label for="building_name" class="form-label">ชื่อสถานที่</label>
                <input type="text" class="w3-input w3-border" name="building_name" value="<?php echo $rowx['building_name'];?>">
            </div>
